...
:::tip
大部分工程都提供了预先构建的 UF2 文件，通常可以在仓库的 Release 中找到。
:::
...
仓库链接：[https://gitee.com/embeddedboys/pico_dm_1p5623_template](https://gitee.com/embeddedboys/pico_dm_1p5623_template)
